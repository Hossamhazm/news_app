import 'StatusResponses.dart';

class ArticalResponses {
  ArticalResponses({
      String? status, 
      num? totalResults, 
  ...
  ArticalResponses.fromJson(dynamic json) {
    _status = json['status'];
...
ArticalResponses copyWith({  String? status,
  num? totalResults,
  List<Articles>? articles,
}) => ArticalResponses(  status: status ?? _status,
